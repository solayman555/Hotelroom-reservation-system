...
C :
    ...
    printf("\n\n\n\n\n\t\t\t\<<<<<<<<<<<<<<<<<<<<<<<<<<\n");
    printf("\t\t\t");
    char p[]="<PLEASE WAIT For YOUR BILL...>";
    int f=strlen(p);
    for(int i=0; i<f; i++)
    {
        printf("%c",p[i]);
...
void addReservation()
{
    ...
    {
        printf("\n\tRoom %d is already booked. Do you want to book it for another date? (Y/N): ", roomNumber);
        char choice;
    ...
    printf("\n\t\t\t---------------------------------\n\t\t\t");
    char a[]="|Reservation added successfully.|";
    int x=strlen(a);
    for(int i=0;i<x;i++)
    {
        printf("%c",a[i]);
...
void displayReservations()
{
    ...
    {
        printf("\t\t-----------------------------\n\t\t");
        char b[]="| No reservations available.|";
        int d=strlen(b);
    for(int i=0;i<d;i++)
    {
        printf("%c",b[i]);
...
void deleteReservation()
{
    system("cls");
    int roomNumber;
    printf("\n\tEnter room number to delete reservation: ");
    scanf("%d", &roomNumber);
